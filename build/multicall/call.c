...
PyInit_call(void)
{
    ...
    PyObject *capsule = PyObject_GetAttrString(tmp, "init_multicall___call");
    Py_DECREF(tmp);
    if (capsule == NULL) return NULL;
    void *init_func = PyCapsule_GetPointer(capsule, "847fc2cb349a9b029d5a__mypyc.init_multicall___call");
    Py_DECREF(capsule);
    if (!init_func) {
        return NULL;
    }

...
class Multicall:
    ...
    def get_base_fee(self, return_signature: tuple = ('base_fee', None)) -> None:
        signature = ['getBasefee()(uint256)']
        self._contract_method(signature, return_signature)

    def get_block_hash(self, block_number: int, return_signature: tuple = ('block_hash', None)) -> None:
        signature = ['getBlockHash(uint256)(bytes32)', block_number]
        self._contract_method(signature, return_signature)

    def get_block_number(self, return_signature: tuple = ('block_number', None)) -> None:
        signature = ['getBlockNumber()(uint256)']
        self._contract_method(signature, return_signature)

    def get_chain_id(self, return_signature: tuple = ('chain_id', None)) -> None:
        signature = ['getChainId()(uint256)']
        self._contract_method(signature, return_signature)

    def get_block_coinbase(self, return_signature: tuple = ('coinbase', None)) -> None:
        signature = ['getCurrentBlockCoinbase()(address)']
        self._contract_method(signature, return_signature)

    def get_block_difficulty(self, return_signature: tuple = ('difficulty', None)) -> None:
        signature = ['getCurrentBlockDifficulty()(address)']
        self._contract_method(signature, return_signature)

    def get_block_gas_limit(self, return_signature: tuple = ('gas_limit', None)) -> None:
        signature = ['getCurrentBlockGasLimit()(uint256)']
        self._contract_method(signature, return_signature)

    def get_block_timestamp(self, return_signature: tuple = ('timestamp', None)) -> None:
        signature = ['getCurrentBlockTimestamp()(uint256)']
        self._contract_method(signature, return_signature)

    def get_eth_balance(self, address: AnyAddress, return_signature: tuple = ('eth_balance', None)) -> None:
        signature = ['getEthBalance(address)(uint256)', address]
        self._contract_method(signature, return_signature)

    def get_last_block_hash(self, return_signature: tuple = ('last_block_hash', None)) -> None:

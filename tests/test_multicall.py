...
def test_multicalll_contract_methods():
    ...
    multi.get_base_fee()
    multi.get_block_hash(1)
    multi.get_block_number()
    multi.get_chain_id()
    multi.get_block_coinbase()
    multi.get_block_difficulty()
    multi.get_block_gas_limit()
    multi.get_block_timestamp()
    multi.get_eth_balance(CHAI, ('custom_balance', None))
    multi.get_last_block_hash()
